...
describe('>>>R E D U C E R --- Test fundingTypeSelect',() => {
  ...
  it('+++ reducer for LOAD_ETHER_BALANCE_BEGIN', () => {
    ...
    state = fundingTypeSelect(state, {type: types.LOAD_ETHER_BALANCE_BEGIN});
  ...
  it('+++ reducer for LOAD_ETHER_BALANCE_FAILURE', () => {
    ...
    state = fundingTypeSelect(state, {type: types.LOAD_ETHER_BALANCE_FAILURE});
